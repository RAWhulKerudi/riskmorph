...
# Set the page configuration and logo
st.set_page_config(page_title="RiskMorph: Credit Risk Modelling", page_icon="images/riskmorph.png")
st.image('images/riskmorph.png', use_container_width=True)
